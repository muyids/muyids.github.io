        ...
        /***/ (
          ...
          external_echarts_.extendSeriesModel({
            ...
            getInitialData: function (option, ecModel) {
              var dimensions = external_echarts_.helper.createDimensions(
                option.data,
                {
            ...
            render: function (seriesModel, ecModel, api) {
              ...
              seriesModel.layoutInstance.ondraw = function (
                ...
                var textEl = new external_echarts_.graphic.Text({
                  style:
                    external_echarts_.helper.createTextStyle(textStyleModel),
                ...
                textEl.ensureState("emphasis").style =
                  external_echarts_.helper.createTextStyle(
                    itemModel.getModel(["emphasis", "textStyle"]),
                    {
                      state: "emphasis",
                    }
                  );
                textEl.ensureState("blur").style =
                  external_echarts_.helper.createTextStyle(
       ...
       if the previous one is canceled (for cancelable events). */
         ...
         if not, update the grid to the current canvas state */
           ...
           (no clearCanvas only works with a canvas, not divs) */
              ...
              timer[timerId] = (
                settings.layoutAnimation ? loopingFunction : setTimeout
              )(function loop() {
                if (!layouting) {
                  return;
                }
          ...
          /* harmony default export */ const layout = WordCloud; // CONCATENATED MODULE: ./src/wordCloud.js
                  ...
                  .mapArray("value", function (value, idx) {
                    ...
                    return [
                      ...
                      itemModel.get("textStyle.fontSize", true) ||
                        external_echarts_.number.linearMap(
                          value,
                          valueExtent,
                          sizeRange
                        ),
          ...
          external_echarts_.registerPreprocessor(function (option) {
            ...
            !external_echarts_.util.isArray(series) &&
              ...
              textStyle &&
                external_echarts_.util.each(compats, function (key) {
                  if (textStyle.hasOwnProperty(key)) {
                    textStyle[
                      "text" + external_echarts_.format.capitalFirst(key)
                    ] = textStyle[key];
                  }
                });
            }
